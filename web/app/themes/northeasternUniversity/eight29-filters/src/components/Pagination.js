  ...
  if (maxPages > 1) {
    paginationOutput = <ul className="eight29-pagination">
      <li className="eight29-pagination-prev">
        <button className="eight29-pagination-arrow" title="Previous Page" onClick={() => clickPrev()} disabled={currentPage <= 1}><span className="icon-chev-left"></span></button>
      </li>

      {pageItems(pageItemsDisplayed)}

      <li className="eight29-pagination-next">
        <button className="eight29-pagination-arrow" title="Next Page" onClick={() => clickNext()} disabled={currentPage >= maxPages}><span className="icon-chev-right"></span></button>
      </li>
    </ul>
  }
