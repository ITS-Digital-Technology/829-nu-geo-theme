                ...
                <div class="footer-bottom__right">
                    ...
                    foreach ( $socials as $social ) :
                        ...
                        if ( $link ) :
                            ...
                            ?>
                        <a class="footer-bottom__social" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
                            <span class="sr-only"><?php echo $aria; ?></span>
                            <span class="footer-bottom__social-icon">
