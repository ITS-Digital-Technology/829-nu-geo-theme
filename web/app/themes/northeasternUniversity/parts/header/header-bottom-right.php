...
<div class="main-header__right">
    ...
    <div class="main-header__right-wrapper">
        ...
        <div class="main-header__bottom-menu">
            <button class="main-header__info-for" role="application" aria-label="information" aria-controls="menu-information-1">              <?php echo __('Info for...', 'northeasternUniversity'); ?>
            </button>
