...
if (class_exists('Tribe__Events__Filterbar__Filter')):
    class Program_Type extends \Tribe__Events__Filterbar__Filter {
    ...
    function tec_kb_create_filter() {
       ...
       new \Program_Type( __( 'Program Type', 'tribe-events-filter-view' ), 'event_program_type' );
    }
    ...
    function tec_kb_filter_map( array $map ) {
        ...
        $map['event_program_type'] = 'Program_Type';
    ...
    function tec_kb_filter_context_locations( array $locations ) {
        ...
        $locations['event_program_type'] = [
        'read' => [
        \Tribe__Context::REQUEST_VAR => [ 'tribe_event_program_type' ] ]
        ];
    ...
    // Make it work in v1.
    add_action( 'tribe_events_filters_create_filters', 'tec_kb_create_filter' );
    // Make it work in v2
